...
var Apartments = mongoose.model("apartments", ApartmentSchema, "listings"); // changed "listings" to "apartments"
var Houses = mongoose.model("houses", HouseSchema, "listings"); // changed "listings" to "houses"
